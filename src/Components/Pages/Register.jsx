...
const Register = () => {
    ...
    return (
        ...
        <div className="h-screen flex items-center justify-center  ">
            <div className="p-12 relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none shadow-xl rounded-xl">
                ...
                <form onSubmit={handleRegister} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                    ...
                    <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
                        ...
                        <NavLink className="font-medium text-pink-500 transition-colors hover:text-blue-700" to='/'>Sign In</NavLink>
                    </p>
                </form>
                {
